...
SRC_LEXER = src/lexer/lexer.c src/lexer/lexer_utils.c src/lexer/lexer_utils2.c src/lexer/lexer_utils3.c src/lexer/wildcards.c src/lexer/wildcards2.c src/lexer/wildcards_utils.c src/lexer/lexer_errors.c src/lexer/expand_utils.c src/lexer/lexer_expand.c

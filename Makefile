...
SRC_BUILTIN = src/builtin/builtin_checker.c src/builtin/builtin_echo.c src/builtin/builtin_env.c src/builtin/builtin_unset.c src/builtin/builtin_exit.c src/builtin/builtin_paths.c src/builtin/builtin_utils.c src/builtin/builtin_utils2.c
...
SRC_PARSER = src/parser/create_ast.c src/parser/parser_utils.c src/parser/quotes_handler.c src/parser/expend_handler.c
...
SRC_EXECUTOR = src/executor/execution.c src/executor/simple_exe.c src/executor/simple_cmd_redir.c src/executor/put_heredoc.c src/executor/simple_parse_path.c src/executor/simple_parse_cmd.c src/executor/exec_utils.c \
				src/executor/cmd_errors.c src/executor/pipes_parse_path.c src/executor/pipes_clist.c src/executor/pipes_exec.c src/executor/pipes_parse_cmd.c src/executor/pipes_redir.c src/executor/std_dup.c
